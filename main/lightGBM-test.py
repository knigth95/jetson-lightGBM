...
if __name__ == '__main__':
    ...
    with open('./train_model/36Model.pkl', 'rb') as fin:
    ...
    while True:
        ...
        '''        
        if aboveclf.predict(np.array([sig1_feature_1, sig1_feature_2]).reshape(1, -1)):
            ads.LED_On()
        ...
        time_second=0.02
        I1,I2,Q1,Q2=[],[],[],[]
        for idx in range(0,int(Fs*time_second)):
